...
const initiateSpotifyLogin = () => {
  ...
  const scopes =
    "user-read-private user-read-email user-library-read user-follow-read user-top-read user-follow-modify user-follow-read playlist-modify-public playlist-modify-private playlist-read-collaborative playlist-read-private";
